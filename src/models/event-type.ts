...
export const EventType = {
    ...
    IssuedDocumentsEInvoices: 'it.fattureincloud.webhooks.issued_documents.e_invoices',
    ReceivedDocumentsEInvoices: 'it.fattureincloud.webhooks.received_documents.e_invoices'
} as const;
