...
import { VerifyEInvoiceXmlErrorResponseError } from './verify-einvoice-xml-error-response-error';
import { VerifyEInvoiceXmlErrorResponseExtra } from './verify-einvoice-xml-error-response-extra';
