...
// @ts-ignore
import type { IssuedDocumentPaymentsListItemPaymentTerms } from './issued-document-payments-list-item-payment-terms';
// May contain unused imports in some cases
// @ts-ignore
import type { IssuedDocumentStatus } from './issued-document-status';
// May contain unused imports in some cases
// @ts-ignore
