...
export const ArchiveApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getArchiveDocument: async (companyId: number, documentId: number, fields?: string, fieldset?: GetArchiveDocumentFieldsetEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listArchiveDocuments: async (companyId: number, fields?: string, fieldset?: ListArchiveDocumentsFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        uploadArchiveDocumentAttachment: async (companyId: number, filename?: string | null, attachment?: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const ArchiveApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createArchiveDocument(companyId: number, createArchiveDocumentRequest?: CreateArchiveDocumentRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateArchiveDocumentResponse>> {
            ...
            const operationBasePath = operationServerMap['ArchiveApi.createArchiveDocument']?.[index]?.url;
        ...
        async deleteArchiveDocument(companyId: number, documentId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArchiveApi.deleteArchiveDocument']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the specified archive document.
         ...
         * @throws {RequiredError}
         */
        async getArchiveDocument(companyId: number, documentId: number, fields?: string, fieldset?: GetArchiveDocumentFieldsetEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetArchiveDocumentResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getArchiveDocument(companyId, documentId, fields, fieldset, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArchiveApi.getArchiveDocument']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Lists the archive documents.
         ...
         * @throws {RequiredError}
         */
        async listArchiveDocuments(companyId: number, fields?: string, fieldset?: ListArchiveDocumentsFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListArchiveDocumentsResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArchiveApi.listArchiveDocuments']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Modifies the specified archive document.
        ...
        async modifyArchiveDocument(companyId: number, documentId: number, modifyArchiveDocumentRequest?: ModifyArchiveDocumentRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModifyArchiveDocumentResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArchiveApi.modifyArchiveDocument']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Uploads an attachment destined to an archive document. The actual association between the document and the attachment must be implemented separately, using the returned token.
         ...
         * @throws {RequiredError}
         */
        async uploadArchiveDocumentAttachment(companyId: number, filename?: string | null, attachment?: File, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UploadArchiveAttachmentResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArchiveApi.uploadArchiveDocumentAttachment']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export interface ArchiveApiInterface {
     ...
     * @memberof ArchiveApiInterface
     */
    getArchiveDocument(companyId: number, documentId: number, fields?: string, fieldset?: GetArchiveDocumentFieldsetEnum, options?: AxiosRequestConfig): AxiosPromise<GetArchiveDocumentResponse>;
     ...
     * @memberof ArchiveApiInterface
     */
    listArchiveDocuments(companyId: number, fields?: string, fieldset?: ListArchiveDocumentsFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig): AxiosPromise<ListArchiveDocumentsResponse>;
     ...
     * @memberof ArchiveApiInterface
     */
    uploadArchiveDocumentAttachment(companyId: number, filename?: string | null, attachment?: File, options?: AxiosRequestConfig): AxiosPromise<UploadArchiveAttachmentResponse>;
...
export class ArchiveApi extends BaseAPI implements ArchiveApiInterface {
     ...
     * @memberof ArchiveApi
     */
    public getArchiveDocument(companyId: number, documentId: number, fields?: string, fieldset?: GetArchiveDocumentFieldsetEnum, options?: AxiosRequestConfig) {
     ...
     * @memberof ArchiveApi
     */
    public listArchiveDocuments(companyId: number, fields?: string, fieldset?: ListArchiveDocumentsFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig) {
     ...
     * @memberof ArchiveApi
     */
    public uploadArchiveDocumentAttachment(companyId: number, filename?: string | null, attachment?: File, options?: AxiosRequestConfig) {
