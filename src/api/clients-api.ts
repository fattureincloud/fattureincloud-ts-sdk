...
// @ts-ignore
import type { GetEntityClientPreCreateInfoResponse } from '../../src/models';
// @ts-ignore
...
export const ClientsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getClientInfo: async (companyId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
            assertParamExists('getClientInfo', 'companyId', companyId)
            const localVarPath = `/c/{company_id}/entities/clients/info`
                .replace(`{${"company_id"}}`, encodeURIComponent(String(companyId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ClientsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getClientInfo(companyId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetEntityClientPreCreateInfoResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getClientInfo(companyId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ClientsApi.getClientInfo']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Lists the clients.
...
export const ClientsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getClientInfo(companyId: number, options?: RawAxiosRequestConfig): AxiosPromise<GetEntityClientPreCreateInfoResponse> {
            return localVarFp.getClientInfo(companyId, options).then((request) => request(axios, basePath));
        },
        /**
         * Lists the clients.
         * @summary List Clients
...
export class ClientsApi extends BaseAPI implements ClientsApiInterface {
     ...
     * @memberof ClientsApi
     */
    public getClientInfo(companyId: number, options?: RawAxiosRequestConfig) {
        return ClientsApiFp(this.configuration).getClientInfo(companyId, options).then((request) => request(this.axios, this.basePath));
    }
