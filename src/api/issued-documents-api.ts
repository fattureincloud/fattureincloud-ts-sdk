...
export const IssuedDocumentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {0 | 1} [group] Group items.
         * @param {0 | 1} [eInvoice] New document e_invoice.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        joinIssuedDocuments: async (companyId: number, ids: string, group?: 0 | 1, eInvoice?: 0 | 1, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        uploadIssuedDocumentAttachment: async (companyId: number, filename?: string, attachment?: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const IssuedDocumentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async joinIssuedDocuments(companyId: number, ids: string, group?: 0 | 1, eInvoice?: 0 | 1, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JoinIssuedDocumentsResponse>> {
         ...
         * @throws {RequiredError}
         */
        async listIssuedDocuments(companyId: number, type: 'invoice' | 'quote' | 'proforma' | 'receipt' | 'delivery_note' | 'credit_note' | 'order' | 'work_report' | 'supplier_order' | 'self_own_invoice' | 'self_supplier_invoice', fields?: string, fieldset?: 'basic' | 'detailed', sort?: string, page?: number, perPage?: number, q?: string, inclusive?: 0 | 1, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListIssuedDocumentsResponse>> {
         ...
         * @throws {RequiredError}
         */
        async uploadIssuedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UploadIssuedDocumentAttachmentResponse>> {
...
export const IssuedDocumentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        joinIssuedDocuments(companyId: number, ids: string, group?: 0 | 1, eInvoice?: 0 | 1, options?: any): AxiosPromise<JoinIssuedDocumentsResponse> {
         ...
         * @throws {RequiredError}
         */
        uploadIssuedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: any): AxiosPromise<UploadIssuedDocumentAttachmentResponse> {
...
export interface IssuedDocumentsApiInterface {
     ...
     * @memberof IssuedDocumentsApiInterface
     */
    joinIssuedDocuments(companyId: number, ids: string, group?: 0 | 1, eInvoice?: 0 | 1, options?: AxiosRequestConfig): AxiosPromise<JoinIssuedDocumentsResponse>;
     ...
     * @memberof IssuedDocumentsApiInterface
     */
    listIssuedDocuments(companyId: number, type: 'invoice' | 'quote' | 'proforma' | 'receipt' | 'delivery_note' | 'credit_note' | 'order' | 'work_report' | 'supplier_order' | 'self_own_invoice' | 'self_supplier_invoice', fields?: string, fieldset?: 'basic' | 'detailed', sort?: string, page?: number, perPage?: number, q?: string, inclusive?: 0 | 1, options?: AxiosRequestConfig): AxiosPromise<ListIssuedDocumentsResponse>;
     ...
     * @memberof IssuedDocumentsApiInterface
     */
    uploadIssuedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: AxiosRequestConfig): AxiosPromise<UploadIssuedDocumentAttachmentResponse>;
...
export class IssuedDocumentsApi extends BaseAPI implements IssuedDocumentsApiInterface {
     ...
     * @memberof IssuedDocumentsApi
     */
    public joinIssuedDocuments(companyId: number, ids: string, group?: 0 | 1, eInvoice?: 0 | 1, options?: AxiosRequestConfig) {
     ...
     * @memberof IssuedDocumentsApi
     */
    public listIssuedDocuments(companyId: number, type: 'invoice' | 'quote' | 'proforma' | 'receipt' | 'delivery_note' | 'credit_note' | 'order' | 'work_report' | 'supplier_order' | 'self_own_invoice' | 'self_supplier_invoice', fields?: string, fieldset?: 'basic' | 'detailed', sort?: string, page?: number, perPage?: number, q?: string, inclusive?: 0 | 1, options?: AxiosRequestConfig) {
     ...
     * @memberof IssuedDocumentsApi
     */
    public uploadIssuedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: AxiosRequestConfig) {
