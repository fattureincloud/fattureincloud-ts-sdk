...
export const IssuedDocumentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createIssuedDocument: async (companyId: number, createIssuedDocumentRequest?: CreateIssuedDocumentRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "OAuth2AuthenticationCodeFlow", ["issued_documents.invoice:a", "issued_documents.credit_note:a", "issued_documents.receipt:a", "issued_documents.order:a", "issued_documents.quote:a", "issued_documents.proforma:a", "issued_documents.delivery_note:a"], configuration)
        ...
        getEmailData: async (companyId: number, documentId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // authentication OAuth2AuthenticationCodeFlow required
            // oauth required
            await setOAuthToObject(localVarHeaderParameter, "OAuth2AuthenticationCodeFlow", ["issued_documents.invoice:r", "issued_documents.credit_note:r", "issued_documents.receipt:r", "issued_documents.order:r", "issued_documents.quote:r", "issued_documents.proforma:r", "issued_documents.delivery_note:r"], configuration)
         ...
         * @param {number} companyId The ID of the company.
         * @param {'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note'} type The type of the issued document.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getIssuedDocumentPreCreateInfo: async (companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listIssuedDocuments: async (companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', fields?: string, fieldset?: 'basic' | 'detailed', sort?: string, page?: number, perPage?: number, q?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const IssuedDocumentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getIssuedDocumentPreCreateInfo(companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetIssuedDocumentPreCreateInfoResponse>> {
...
export const IssuedDocumentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getIssuedDocumentPreCreateInfo(companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', options?: any): AxiosPromise<GetIssuedDocumentPreCreateInfoResponse> {
         ...
         * @throws {RequiredError}
         */
        listIssuedDocuments(companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', fields?: string, fieldset?: 'basic' | 'detailed', sort?: string, page?: number, perPage?: number, q?: string, options?: any): AxiosPromise<ListIssuedDocumentsResponse> {
...
export interface IssuedDocumentsApiInterface {
     ...
     * @memberof IssuedDocumentsApiInterface
     */
    getIssuedDocumentPreCreateInfo(companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', options?: AxiosRequestConfig): AxiosPromise<GetIssuedDocumentPreCreateInfoResponse>;
     ...
     * @memberof IssuedDocumentsApiInterface
     */
    listIssuedDocuments(companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', fields?: string, fieldset?: 'basic' | 'detailed', sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig): AxiosPromise<ListIssuedDocumentsResponse>;
...
export class IssuedDocumentsApi extends BaseAPI implements IssuedDocumentsApiInterface {
     ...
     * @memberof IssuedDocumentsApi
     */
    public getIssuedDocumentPreCreateInfo(companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', options?: AxiosRequestConfig) {
     ...
     * @memberof IssuedDocumentsApi
     */
    public listIssuedDocuments(companyId: number, type: 'invoice' | 'credit_note' | 'receipt' | 'order' | 'quote' | 'proforma' | 'delivery_note', fields?: string, fieldset?: 'basic' | 'detailed', sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig) {
