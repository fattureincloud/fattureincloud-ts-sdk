...
export const ReceivedDocumentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        uploadReceivedDocumentAttachment: async (companyId: number, filename?: string, attachment?: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const ReceivedDocumentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadReceivedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UploadReceivedDocumentAttachmentResponse>> {
...
export const ReceivedDocumentsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        uploadReceivedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: any): AxiosPromise<UploadReceivedDocumentAttachmentResponse> {
...
export interface ReceivedDocumentsApiInterface {
     ...
     * @memberof ReceivedDocumentsApiInterface
     */
    uploadReceivedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: AxiosRequestConfig): AxiosPromise<UploadReceivedDocumentAttachmentResponse>;
...
export class ReceivedDocumentsApi extends BaseAPI implements ReceivedDocumentsApiInterface {
     ...
     * @memberof ReceivedDocumentsApi
     */
    public uploadReceivedDocumentAttachment(companyId: number, filename?: string, attachment?: File, options?: AxiosRequestConfig) {
