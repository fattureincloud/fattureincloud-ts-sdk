...
export const TaxesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getF24: async (companyId: number, documentId: number, fields?: string, fieldset?: GetF24FieldsetEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listF24: async (companyId: number, fields?: string, fieldset?: ListF24FieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        uploadF24Attachment: async (companyId: number, filename?: string | null, attachment?: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const TaxesApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createF24(companyId: number, createF24Request?: CreateF24Request, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateF24Response>> {
            ...
            const operationBasePath = operationServerMap['TaxesApi.createF24']?.[index]?.url;
        ...
        async deleteF24(companyId: number, documentId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TaxesApi.deleteF24']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Removes the attachment of the specified F24.
        ...
        async deleteF24Attachment(companyId: number, documentId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TaxesApi.deleteF24Attachment']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the specified F24.
         ...
         * @throws {RequiredError}
         */
        async getF24(companyId: number, documentId: number, fields?: string, fieldset?: GetF24FieldsetEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetF24Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getF24(companyId, documentId, fields, fieldset, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TaxesApi.getF24']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Lists the F24s.
         ...
         * @throws {RequiredError}
         */
        async listF24(companyId: number, fields?: string, fieldset?: ListF24FieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListF24Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listF24(companyId, fields, fieldset, sort, page, perPage, q, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TaxesApi.listF24']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Modifies the specified F24.
        ...
        async modifyF24(companyId: number, documentId: number, modifyF24Request?: ModifyF24Request, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModifyF24Response>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TaxesApi.modifyF24']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Uploads an attachment destined to a F24. The actual association between the document and the attachment must be implemented separately, using the returned token.
         ...
         * @throws {RequiredError}
         */
        async uploadF24Attachment(companyId: number, filename?: string | null, attachment?: File, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UploadF24AttachmentResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadF24Attachment(companyId, filename, attachment, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['TaxesApi.uploadF24Attachment']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export interface TaxesApiInterface {
     ...
     * @memberof TaxesApiInterface
     */
    getF24(companyId: number, documentId: number, fields?: string, fieldset?: GetF24FieldsetEnum, options?: AxiosRequestConfig): AxiosPromise<GetF24Response>;
     ...
     * @memberof TaxesApiInterface
     */
    listF24(companyId: number, fields?: string, fieldset?: ListF24FieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig): AxiosPromise<ListF24Response>;
     ...
     * @memberof TaxesApiInterface
     */
    uploadF24Attachment(companyId: number, filename?: string | null, attachment?: File, options?: AxiosRequestConfig): AxiosPromise<UploadF24AttachmentResponse>;
...
export class TaxesApi extends BaseAPI implements TaxesApiInterface {
     ...
     * @memberof TaxesApi
     */
    public getF24(companyId: number, documentId: number, fields?: string, fieldset?: GetF24FieldsetEnum, options?: AxiosRequestConfig) {
     ...
     * @memberof TaxesApi
     */
    public listF24(companyId: number, fields?: string, fieldset?: ListF24FieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig) {
     ...
     * @memberof TaxesApi
     */
    public uploadF24Attachment(companyId: number, filename?: string | null, attachment?: File, options?: AxiosRequestConfig) {
