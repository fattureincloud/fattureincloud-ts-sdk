...
export const TaxesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createF24: async (companyId: number, createF24Request?: CreateF24Request, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarHeaderParameter['User-Agent'] = 'FattureInCloud/2.0.3/TypeScript-SDK';
         ...
         * @throws {RequiredError}
         */
        uploadF24Attachment: async (companyId: number, filename?: string, attachment?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const TaxesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadF24Attachment(companyId: number, filename?: string, attachment?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UploadF24AttachmentResponse>> {
...
export const TaxesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        uploadF24Attachment(companyId: number, filename?: string, attachment?: any, options?: any): AxiosPromise<UploadF24AttachmentResponse> {
...
export interface TaxesApiInterface {
     ...
     * @memberof TaxesApiInterface
     */
    uploadF24Attachment(companyId: number, filename?: string, attachment?: any, options?: AxiosRequestConfig): AxiosPromise<UploadF24AttachmentResponse>;
...
export class TaxesApi extends BaseAPI implements TaxesApiInterface {
     ...
     * @memberof TaxesApi
     */
    public uploadF24Attachment(companyId: number, filename?: string, attachment?: any, options?: AxiosRequestConfig) {
