...
export const IssuedEInvoicesApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getEInvoiceRejectionReason(companyId: number, documentId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetEInvoiceRejectionReasonResponse>> {
            ...
            const operationBasePath = operationServerMap['IssuedEInvoicesApi.getEInvoiceRejectionReason']?.[index]?.url;
        ...
        async getEInvoiceXml(companyId: number, documentId: number, includeAttachment?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['IssuedEInvoicesApi.getEInvoiceXml']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Sends the e-invoice to SDI.
        ...
        async sendEInvoice(companyId: number, documentId: number, sendEInvoiceRequest?: SendEInvoiceRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SendEInvoiceResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['IssuedEInvoicesApi.sendEInvoice']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Verifies the e-invoice XML format. Checks if all of the mandatory fields are filled and compliant to the right format.
        ...
        async verifyEInvoiceXml(companyId: number, documentId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VerifyEInvoiceXmlResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['IssuedEInvoicesApi.verifyEInvoiceXml']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
