...
export const SuppliersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSupplier: async (companyId: number, supplierId: number, fields?: string, fieldset?: GetSupplierFieldsetEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listSuppliers: async (companyId: number, fields?: string, fieldset?: ListSuppliersFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const SuppliersApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createSupplier(companyId: number, createSupplierRequest?: CreateSupplierRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateSupplierResponse>> {
            ...
            const operationBasePath = operationServerMap['SuppliersApi.createSupplier']?.[index]?.url;
        ...
        async deleteSupplier(companyId: number, supplierId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['SuppliersApi.deleteSupplier']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the specified supplier.
         ...
         * @throws {RequiredError}
         */
        async getSupplier(companyId: number, supplierId: number, fields?: string, fieldset?: GetSupplierFieldsetEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetSupplierResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSupplier(companyId, supplierId, fields, fieldset, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['SuppliersApi.getSupplier']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Lists the suppliers.
         ...
         * @throws {RequiredError}
         */
        async listSuppliers(companyId: number, fields?: string, fieldset?: ListSuppliersFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListSuppliersResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['SuppliersApi.listSuppliers']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Modifies the specified supplier.
        ...
        async modifySupplier(companyId: number, supplierId: number, modifySupplierRequest?: ModifySupplierRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModifySupplierResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['SuppliersApi.modifySupplier']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export interface SuppliersApiInterface {
     ...
     * @memberof SuppliersApiInterface
     */
    getSupplier(companyId: number, supplierId: number, fields?: string, fieldset?: GetSupplierFieldsetEnum, options?: AxiosRequestConfig): AxiosPromise<GetSupplierResponse>;
     ...
     * @memberof SuppliersApiInterface
     */
    listSuppliers(companyId: number, fields?: string, fieldset?: ListSuppliersFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig): AxiosPromise<ListSuppliersResponse>;
...
export class SuppliersApi extends BaseAPI implements SuppliersApiInterface {
     ...
     * @memberof SuppliersApi
     */
    public getSupplier(companyId: number, supplierId: number, fields?: string, fieldset?: GetSupplierFieldsetEnum, options?: AxiosRequestConfig) {
     ...
     * @memberof SuppliersApi
     */
    public listSuppliers(companyId: number, fields?: string, fieldset?: ListSuppliersFieldsetEnum, sort?: string, page?: number, perPage?: number, q?: string, options?: AxiosRequestConfig) {
