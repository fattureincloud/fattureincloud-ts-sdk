...
export const CashbookApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getCashbookEntry: async (companyId: number, documentId: string, fields?: string, fieldset?: GetCashbookEntryFieldsetEnum, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listCashbookEntries: async (companyId: number, dateFrom: string, dateTo: string, year?: number, type?: ListCashbookEntriesTypeEnum, paymentAccountId?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'companyId' is not null or undefined
...
export const CashbookApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createCashbookEntry(companyId: number, createCashbookEntryRequest?: CreateCashbookEntryRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateCashbookEntryResponse>> {
            ...
            const operationBasePath = operationServerMap['CashbookApi.createCashbookEntry']?.[index]?.url;
        ...
        async deleteCashbookEntry(companyId: number, documentId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['CashbookApi.deleteCashbookEntry']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the specified cashbook entry.
         ...
         * @throws {RequiredError}
         */
        async getCashbookEntry(companyId: number, documentId: string, fields?: string, fieldset?: GetCashbookEntryFieldsetEnum, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetCashbookEntryResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCashbookEntry(companyId, documentId, fields, fieldset, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['CashbookApi.getCashbookEntry']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Lists the cashbook entries.
         ...
         * @throws {RequiredError}
         */
        async listCashbookEntries(companyId: number, dateFrom: string, dateTo: string, year?: number, type?: ListCashbookEntriesTypeEnum, paymentAccountId?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListCashbookEntriesResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['CashbookApi.listCashbookEntries']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Modifies the specified cashbook entry.
        ...
        async modifyCashbookEntry(companyId: number, documentId: string, modifyCashbookEntryRequest?: ModifyCashbookEntryRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModifyCashbookEntryResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['CashbookApi.modifyCashbookEntry']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export interface CashbookApiInterface {
     ...
     * @memberof CashbookApiInterface
     */
    getCashbookEntry(companyId: number, documentId: string, fields?: string, fieldset?: GetCashbookEntryFieldsetEnum, options?: AxiosRequestConfig): AxiosPromise<GetCashbookEntryResponse>;
     ...
     * @memberof CashbookApiInterface
     */
    listCashbookEntries(companyId: number, dateFrom: string, dateTo: string, year?: number, type?: ListCashbookEntriesTypeEnum, paymentAccountId?: number, options?: AxiosRequestConfig): AxiosPromise<ListCashbookEntriesResponse>;
...
export class CashbookApi extends BaseAPI implements CashbookApiInterface {
     ...
     * @memberof CashbookApi
     */
    public getCashbookEntry(companyId: number, documentId: string, fields?: string, fieldset?: GetCashbookEntryFieldsetEnum, options?: AxiosRequestConfig) {
     ...
     * @memberof CashbookApi
     */
    public listCashbookEntries(companyId: number, dateFrom: string, dateTo: string, year?: number, type?: ListCashbookEntriesTypeEnum, paymentAccountId?: number, options?: AxiosRequestConfig) {
