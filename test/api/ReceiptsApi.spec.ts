...
import { CreateReceiptRequest, CreateReceiptResponse, GetReceiptPreCreateInfoResponse, GetReceiptResponse, GetReceiptsMonthlyTotalsResponse, ListReceiptsResponse, ModifyReceiptRequest, ModifyReceiptResponse } from '../../src/models';
  ...
  var instance = new ReceiptsApi();

  var createReceiptResponse: CreateReceiptResponse = {"data":{"id":12346,"date":"2021-08-19","number":6,"numeration":"REC006","amount_net":8.2,"amount_gross":10,"use_gross_prices":true,"type":"sales_receipt","description":"cassa 1","rc_center":"","created_at":"2021-08-19 17:57:56","updated_at":"2021-08-19 17:57:56","payment_account":{"id":555,"name":"contanti"},"items_list":[{"id":888,"amount_net":8.2,"amount_gross":10,"category":"altro","vat":{"id":0,"value":22,"description":"iva"}}]}};
  var createReceiptStub = sandbox.stub(instance, "createReceipt").returns(createReceiptResponse);

  var deleteReceiptResponse = {};
  sandbox.stub(instance, "deleteReceipt").returns(deleteReceiptResponse);

  var getReceiptResponse: GetReceiptResponse = {"data":{"id":12346,"date":"2021-08-19","number":6,"numeration":"REC006","amount_net":8.2,"amount_gross":10,"use_gross_prices":true,"type":"sales_receipt","description":"cassa 1","rc_center":"","created_at":"2021-08-19 17:57:56","updated_at":"2021-08-19 17:57:56","payment_account":{"id":555,"name":"contanti"},"items_list":[{"id":888,"amount_net":8.2,"amount_gross":10,"category":"altro","vat":{"id":0,"value":22,"description":"iva"}}]}};
  ...
  describe('ReceiptsApi', function() {
    ...
    describe('getReceipt', function() {
      it('should call getReceipt successfully', function(done) {
        var response = instance.getReceipt(2, 135);
        var expectedJson = JSON.stringify(getReceiptResponse);
        var actualJson = JSON.stringify(response);
        expect(actualJson).to.equal(expectedJson);
        done();
      });
    ...
    describe('getReceiptPreCreateInfo', function() {
      it('should call getReceiptPreCreateInfo successfully', function(done) {
        var response = instance.getReceiptPreCreateInfo(2);
        var expectedJson = JSON.stringify(getReceiptPreCreateInfoResponse);
        var actualJson = JSON.stringify(response);
        expect(actualJson).to.equal(expectedJson);
        done();
      });
    ...
    describe('getReceiptsMonthlyTotals', function() {
      it('should call getReceiptsMonthlyTotals successfully', function(done) {
        var response = instance.getReceiptsMonthlyTotals(2, "sales_receipt", "2022");
        var expectedJson = JSON.stringify(getReceiptsMonthlyTotalsResponse);
        var actualJson = JSON.stringify(response);
        expect(actualJson).to.equal(expectedJson);
        done();
      });
    ...
    describe('listReceipts', function() {
      it('should call listReceipts successfully', function(done) {
        var response = instance.listReceipts(2);
        var expectedJson = JSON.stringify(listReceiptsResponse);
        var actualJson = JSON.stringify(response);
        expect(actualJson).to.equal(expectedJson);
        done();
      });
    ...
    describe('modifyReceipt', function() {
      it('should call modifyReceipt successfully', function(done) {
        var opts: ModifyReceiptRequest = {"data":{"description":"ssss"}}
        var response = instance.modifyReceipt(2, 12345, opts);
        var expectedJson = JSON.stringify(modifyReceiptResponse);
        var actualJson = JSON.stringify(response);
        expect(actualJson).to.equal(expectedJson);
