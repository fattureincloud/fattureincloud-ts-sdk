...
describe('ReceiptsApi', function () {
  describe('createReceipt', function () {
    it('should call createReceipt successfully', function (done) {
      const opts: CreateReceiptRequest = { data: { date: '2021-08-19', number: 6, numeration: 'rreccc', amount_net: 8.2, amount_gross: 10, use_gross_prices: true, type: 'sales_receipt', description: 'cassa 1', rc_center: '', payment_account: { id: 21, name: 'contanti' }, items_list: [{ id: 888, amount_net: 8.2, amount_gross: 10, category: 'altro', vat: { id: 1409, value: 22, description: 'iva' } }] } }
      const response = instance.createReceipt(2, opts)

      const expectedJson = JSON.stringify(createReceiptResponse)
  ...
  describe('getReceipt', function () {
    it('should call getReceipt successfully', function (done) {
      const response = instance.getReceipt(2, 135)
      const expectedJson = JSON.stringify(getReceiptResponse)
      const actualJson = JSON.stringify(response)
      expect(actualJson).to.equal(expectedJson)
      done()
    })
  ...
  describe('getReceiptPreCreateInfo', function () {
    it('should call getReceiptPreCreateInfo successfully', function (done) {
      const response = instance.getReceiptPreCreateInfo(2)
      const expectedJson = JSON.stringify(getReceiptPreCreateInfoResponse)
      const actualJson = JSON.stringify(response)
      expect(actualJson).to.equal(expectedJson)
      done()
    })
  ...
  describe('getReceiptsMonthlyTotals', function () {
    it('should call getReceiptsMonthlyTotals successfully', function (done) {
      const response = instance.getReceiptsMonthlyTotals(2, 'sales_receipt', '2022')
      const expectedJson = JSON.stringify(getReceiptsMonthlyTotalsResponse)
      const actualJson = JSON.stringify(response)
      expect(actualJson).to.equal(expectedJson)
      done()
    })
  ...
  describe('listReceipts', function () {
    it('should call listReceipts successfully', function (done) {
      const response = instance.listReceipts(2)
      const expectedJson = JSON.stringify(listReceiptsResponse)
      const actualJson = JSON.stringify(response)
      expect(actualJson).to.equal(expectedJson)
      done()
    })
  ...
  describe('modifyReceipt', function () {
    it('should call modifyReceipt successfully', function (done) {
      const opts: ModifyReceiptRequest = { data: { description: 'ssss' } }
      const response = instance.modifyReceipt(2, 12345, opts)
      const expectedJson = JSON.stringify(modifyReceiptResponse)
      const actualJson = JSON.stringify(response)
      expect(actualJson).to.equal(expectedJson)
