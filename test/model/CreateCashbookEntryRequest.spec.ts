...
const instance: CreateCashbookEntryRequest = {
  data: {
    date: '2021-08-24',
    amount_in: 122,
    payment_account_in: {
...
describe('CreateCashbookEntryRequest', function () {
  it('should create an instance of CreateCashbookEntryRequest', function () {
