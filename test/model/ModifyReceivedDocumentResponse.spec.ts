...
const instance: ModifyReceivedDocumentResponse = {
  data: {
    id: 12345,
    type: 'expense',
...
describe('ModifyReceivedDocumentResponse', function () {
  it('should create an instance of ModifyReceivedDocumentResponse', function () {
