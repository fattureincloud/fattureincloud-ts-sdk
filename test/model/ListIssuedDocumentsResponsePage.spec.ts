...
import { ListIssuedDocumentsResponsePage } from '../../src/models'

const instance: ListIssuedDocumentsResponsePage = {
  data: [
    {
      id: 12345,
      type: 'invoice',
...
describe('ListIssuedDocumentsResponsePage', function () {
  it('should create an instance of ListIssuedDocumentsResponsePage', function () {
