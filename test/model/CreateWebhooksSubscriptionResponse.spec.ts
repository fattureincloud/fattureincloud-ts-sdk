...
const instance: CreateWebhooksSubscriptionResponse = {
  data: {
    id: 'SUB123',
...
describe('CreateWebhooksSubscriptionResponse', function () {
  it('should create an instance of CreateWebhooksSubscriptionResponse', function () {
