 ...
 *
 */
import { GetBinIssuedDocumentResponse } from '../../src/models'
import { expect } from 'chai'

const instance: GetBinIssuedDocumentResponse = {
  data: {
    id: 12345,
    type: 'invoice',
    year: 2021,
...
describe('GetBinIssuedDocumentResponse', function () {
  it('should create an instance of GetBinIssuedDocumentResponse', function () {
