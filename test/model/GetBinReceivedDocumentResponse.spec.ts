 ...
 *
 */
import { GetBinReceivedDocumentResponse } from '../../src/models'
import { expect } from 'chai'

const instance: GetBinReceivedDocumentResponse = {
  data: {
    id: 12345,
    type: 'expense',
...
describe('GetBinReceivedDocumentResponse', function () {
  it('should create an instance of GetBinReceivedDocumentResponse', function () {
