...
let parameter = "delivery_notes, orders, quotes, work_reports" // String | Type of the parameters to be joined

apiInstance.joinIssuedDocuments(companyId, ids, parameter).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let parameter = "parameter_example", // String | Old document type.
